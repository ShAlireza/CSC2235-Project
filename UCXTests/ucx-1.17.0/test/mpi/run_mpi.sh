...
{
	export MPIRUN=
	export LIBUCS=/home/tabbahch/Desktop/UCXTests/ucx-1.17.0/src/ucs/.libs/libucs.so
	export LIBUCT=/home/tabbahch/Desktop/UCXTests/ucx-1.17.0/src/uct/.libs/libuct.so
	export LIBUCP=/home/tabbahch/Desktop/UCXTests/ucx-1.17.0/src/ucp/.libs/libucp.so
	export VERBOSE=0
	export EXE=""
	export EXE_ARGS=""
...
run_open_mpi()
{
	...
	then
		...
		EXE="valgrind \
			...
			--suppressions=/home/tabbahch/Desktop/UCXTests/ucx-1.17.0/test/mpi/ompi.supp \
			$VALGRIND_ARGS \
			$EXE"
